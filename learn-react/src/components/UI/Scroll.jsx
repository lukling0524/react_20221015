  ...
  return (
    <div style={{ overflow: "hidden" }}>
      ...
      >
        ...
        perspiciatis ex, adipisci possimus unde. Hic, maxime! Maiores voluptas
        quod, fugit maxime ab cumque unde quam excepturi nisi quis molestias.
      </p>
    </div>
  );
}
...
const ImgBox = styled.div`
  ...
  background: url(${require("../../assets/images/img3.jpg")}) center top / cover
    no-repeat;

  ${({ scrollAmout }) => css`
    background-position: center ${scrollAmout < 600 ? 0 : scrollAmout - 600}px;
  `}
`;
